...
A [timoni.sh](http://timoni.sh) module for deploying timoni-demo to Kubernetes clusters.
...
```shell
timoni -n default apply timoni-demo oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni-demo
```
